...
class VisDiagnosticPlot(object):
    ...
    def fidDiff(self,iteration,keyLength = 0.1):
        ...
        frameId = self.visitId*100+iteration
        ...
        ax.set_ylabel("y")
        ax.set_xlabel("x")
        tString = f'Accuracy of Transform pfs_visit_id = {self.visitId:d}; iteration = {iteration:d}'
    ...
    def visBright(self, iterVal = None):
