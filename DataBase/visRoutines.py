...
def getAllCentroids(files,outfile,thresh1,thresh2,fwhmx,fwhmy,boxFind,boxCent,nmin,nmax,maxIt,frameIDs):        
    ...
    for file in files:
        ...
        for i in range(len(centroids[:,0])):
            ...
            print(frameIDs[filenum],i,centroids[i,1],centroids[i,2],centroids[i,3],centroids[i,4],centroids[i,5],centroids[i,6],centroids[i,7],file=ff)
        filenum+=1
...
def getAllCentroidsTemp(files,outfile,thresh1,thresh2,fwhmx,fwhmy,boxFind,boxCent,nmin,nmax,maxIt,frameIDs):        
